  ...
  return (
    <>
          ...
          <div className="lg:hidden bg-white/90 backdrop-blur-xl border-t border-gray-100/50">
            <div className="px-4 pt-2 pb-4 space-y-1">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={closeMenu}
                className="flex items-center justify-center space-x-2 bg-[#25D366] text-white hover:bg-[#20BA5A] px-4 py-3 rounded-xl text-base font-medium transition-all mt-2 shadow-sm"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
      ...
      {isSearchOpen && (
        ...
        >
          {/* Backdrop */}
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm transition-all duration-500 ease-out animate-in fade-in"></div>
          ...
          >
            <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-2 transform transition-all duration-500 border border-gray-200/50">
              ...
              <div className="relative">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 absolute left-5 top-1/2 transform -translate-y-1/2 text-gray-400 transition-all duration-300"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <button
                  onClick={closeSearch}
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 p-2 text-gray-400 hover:text-black hover:bg-gray-100 rounded-lg transition-all duration-300"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
              ...
              {/* Quick Links */}
              <div className="mt-4 px-4 pb-3 transition-all duration-500 delay-100">
                <div className="text-xs text-gray-500 font-medium mb-2">
                  {language === "TR" ? "Popüler Aramalar" : "Popular Searches"}
                </div>
                <div className="flex flex-wrap gap-2">
                  <button className="px-3 py-1.5 text-sm bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-lg transition-all duration-300 hover:scale-105">
                    Düğme
                  </button>
                  <button className="px-3 py-1.5 text-sm bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-lg transition-all duration-300 hover:scale-105">
                    Fermuar
            ...
            {/* ESC Hint */}
            <div className="mt-4 text-center transition-all duration-500 delay-200 animate-in fade-in slide-in-from-top-2">
